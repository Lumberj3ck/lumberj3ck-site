...
So basically each 1 or 0 in a binary number means a power of 2.

{{< emphasize >}}One{{< / emphasize >}} stands for yes and zero for {{< emphasize >}}No{{< / emphasize >}}.
It means if this power of two is present inside of our number or not.

**Let's build 42 as the sum of powers of 2:**
...
If we want to get a normal number out of binary ('00101010'):
...
So we basically shift all numbers by 1, so it is basically like multiplying by 2.
...
## Use case
We can use binary operators for flags. For example, if in our application we will have the following permissions:
