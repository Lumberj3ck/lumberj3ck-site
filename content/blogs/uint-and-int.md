...
{{< blockquote >}}
In **Go** there are two types representing numbers (excluding floating point numbers): uint and int. The maximum digital value you can store in **int** is 127. In **uint** is 255. Here is why ⬇️
{{< / blockquote >}}
